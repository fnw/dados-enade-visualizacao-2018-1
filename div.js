function fillTextDiv(vis)
{
	...
	else if(vis == 'vis2-top')
	{
		...
		pText = 'Values close to 0 indicate that all institutions have about the same number of top performing students, while values close 1 indicate that a few institutions concentrate the top performers.'
	}
